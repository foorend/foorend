document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            pageTitle: 'FOOREND | 글로벌·한국 푸드 트렌드 아카이브',
            pageDesc: '글로벌·한국 F&B 트렌드를 3시간마다 자동 업데이트. 푸드 트렌드·식품 트렌드 최신 뉴스를 4개 언어로 확인하세요.',
        ...
        en: {
            pageTitle: 'FOOREND | Global & Korean Food Trend Archive',
            pageDesc: 'Global & Korean F&B trend news, auto-updated every 3 hours. Food trends in 4 languages.',
        ...
        ja: {
            pageTitle: 'FOOREND | グローバル・韓国フードトレンドアーカイブ',
            pageDesc: 'グローバル・韓国F&Bトレンドを3時間ごとに自動更新。フードトレンドの最新ニュースを4言語で確認できます。',
        ...
        zh: {
            pageTitle: 'FOOREND | 全球与韩国食品趋势档案',
            pageDesc: '全球与韩国F&B趋势，每3小时自动更新。4种语言获取最新食品趋势。',
